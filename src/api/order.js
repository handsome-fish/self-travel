...
export function getNormalOrderForConsume(obj) {
  return instance.post('api/user/NormalOrder/getNormalOrderForConsume', obj)
}

export function consumeCompanyOrder(obj) {
  return instance.post('api/user/CompanyOrder/toConsume', obj)
}

export function consumeTravelOrder(obj) {
  return instance.post('api/user/order/toConsume', obj)
}

export function newRecommendationOrder(obj) {
  return instance.post('api/user/recommend/newOrder', obj)
}
