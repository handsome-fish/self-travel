...
export function getLine(obj) {
  return instance.post('api/user/line/getLine', obj)
}

export function addLine(obj) {
  return instance.post('api/user/line/addLine', obj)
}

export function updateLine(obj) {
  return instance.post('api/user/line/updateLine', obj)
}

export function deleteLine(obj) {
  return instance.post('api/user/line/deleteLine', obj)
}
