        ...
        <div class="item" v-for="(album, index) in albumTable">
          ...
          <el-row :gutter="20">
            <el-col :offset="2" :span="8">
              <img :src="album.record.base64Datas[0]" :alt="album.record.name" width="100%">
            </el-col>
          </el-row>
          <el-row :gutter="20">
          ...
          <el-row :gutter="20" v-if="commentInputVisible" :id="album.record.id">
            <CommentInput v-bind:album="album" v-bind:user-email="userEmail" @comment="addComment">
            </CommentInput>
          </el-row>
          <el-row :gutter="20" v-if="albumCommentVisible" class="bg-purple-light">
