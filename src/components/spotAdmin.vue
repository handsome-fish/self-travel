    ...
    <el-container class="back">
      ...
      <el-container>
        <el-aside width="100px" class="admin-aside">
          <el-menu
            default-active="spotManageAdmin"
  ...
  export default {
    data() {
      return {
        email :'',
        navList:[
          {name:'spotManageAdmin', navItem:'景点管理'},
          {name:'ticketManageAdmin', navItem: '门票管理'},
          {name:'spotService', navItem: '景点服务'},
          {name:'recommendRoute', navItem: '推荐路线'},
          {name:'commentManage', navItem:'评论管理'},
          {name:'orderStateManage', navItem:'订单管理'},
          {name:'spotAdminInfo', navItem:'个人信息'}
        ]
      }
    },
    methods: {
